	...
	public static void printDot(String filename, int bdd, NodeTable nt, NodeName nn)  {
		try {
   		...
   		BDDPrinter.nn = nn;
			...
			if(had_0)	ps.println("0 [shape=box, label=\"" + "false" + "\", style=filled, shape=box, height=0.3, width=0.3];");
			if(had_1) ps.println("1 [shape=box, label=\"" + "true" + "\", style=filled, shape=box, height=0.3, width=0.3];\n");
